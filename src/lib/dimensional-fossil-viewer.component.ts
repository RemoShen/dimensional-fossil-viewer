...
@Component({
  selector: 'lib-dimensional-fossil-viewer',
  templateUrl: './dimensional-fossil-viewer.component.html',
  styleUrls: ['./dimensional-fossil-viewer.component.scss'],
})
export class DimensionalFossilViewerComponent
